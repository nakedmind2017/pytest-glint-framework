# -*- coding: utf-8 -*-
#
# pytest-glint documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-glint Documentation',
     [author], 1)
]
